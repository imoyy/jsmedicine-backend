...
FROM (
    SELECT 'learning:question:view' AS permission_code, '查看题库' AS permission_name, 'GET' AS api_method, '/api/v1/admin/learning/questions' AS api_path, 220 AS sort_order
    UNION ALL SELECT 'learning:question:edit', '编辑题库', 'POST', '/api/v1/admin/learning/questions', 221
    UNION ALL SELECT 'learning:exam:view', '查看考卷', 'GET', '/api/v1/admin/learning/exam-papers', 230
    UNION ALL SELECT 'learning:exam:edit', '编辑考卷', 'POST', '/api/v1/admin/learning/exam-papers', 231
) permission_seed
WHERE NOT EXISTS (
...
JOIN sys_permissions permission_table
    ON permission_table.permission_code IN (
        'learning:question:view', 'learning:question:edit',
        'learning:exam:view', 'learning:exam:edit'
    )
